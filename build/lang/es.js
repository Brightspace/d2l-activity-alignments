...
window.D2L.SelectOutcomes.Language.Es = {
	...
	'navigationDescription': '{title}: Utilice las teclas de flecha para navegar por {typeName}, use la tecla Eliminar o Retroceso para eliminar {typeName}.',
	'navigationDescriptionNoActions': '{title}: Use teclas de flecha para navegar por {typeName}.',
...
D2L.PolymerBehaviors.SelectOutcomes.LocalizeBehavior.LangEsBehavior = {
	es: window.D2L.SelectOutcomes.Language.Es
};
