...
window.D2L.SelectOutcomes.Language.Fr = {
	...
	'navigationDescription': '{title}: Utilisez les touches fléchées pour naviguer {typeName}, utilisez la touche supprimer ou backspace pour supprimer {typeName}.',
	'navigationDescriptionNoActions': '{title}: Utilisez les touches fléchées pour naviguer {typeName}.',
