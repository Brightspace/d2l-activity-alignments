...
window.D2L.SelectOutcomes.Language.Ko = {
	...
	'navigationDescription': '{title}: 화살표 키를 사용하여 {typeName}을(를) 탐색하고 delete 키 또는 백스페이스 키를 사용하여 {typeName}을(를) 제거합니다.',
	'navigationDescriptionNoActions': '{title}: 화살표 키를 사용하여 {typeName}을(를) 탐색합니다.',
	'noSearchResultFor': '“{searchText}에 대한 검색 결과가 없습니다.',
	'notSelected': '선택되지 않음',
	'outcomesHierarchicalTree': '결과 계층 트리',
	'removeAlignment': '정렬 제거',
	'searchCleared': '검색이 삭제됐습니다.',
	'searchOutcomes': '검색 결과',
