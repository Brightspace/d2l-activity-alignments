...
window.D2L.SelectOutcomes.Language.Tr = {
	...
	'navigationDescription': '{title}: {typeName} öğesine gitmek için ok tuşlarını, {typeName} öğesini kaldırmak için delete veya geri al tuşunu kullanın.',
	'navigationDescriptionNoActions': '{title}: {typeName} öğesine gitmek için ok tuşlarını kullanın.',
