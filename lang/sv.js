...
export default {
	...
	"navigationDescription": "{title}: Använd piltangenterna för att navigera i {typeName} och ta bort {typeName} med backstegstangenten eller Delete-tangenten.",
	"navigationDescriptionNoActions": "{title}: Använd piltangenterna för att navigera i {typeName}.",
